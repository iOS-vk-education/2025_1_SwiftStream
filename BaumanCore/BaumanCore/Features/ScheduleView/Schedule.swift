...
struct Schedule: View {
    ...
    var body: some View {
        ZStack {
            ...
            if showRouteOptions, let classroom = selectedClassroom {
                routeOptionsView(classroom: classroom)
            }
        }
        .onAppear {
    ...
    private var headerView: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                + Text(" \(scheduleVM.localizedGroupName(languageCode: currentLanguageCode))")
    ...
    private func routeOptionsView(classroom: String) -> some View {
        ZStack {
